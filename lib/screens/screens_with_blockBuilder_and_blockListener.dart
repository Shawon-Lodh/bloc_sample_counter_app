...
class ScreensWithBlockBuilderAndBlockListener extends StatefulWidget {
  const ScreensWithBlockBuilderAndBlockListener({Key? key, required this.title})
      : super(key: key);
  final String title;

  @override
  State<ScreensWithBlockBuilderAndBlockListener> createState() =>
      _ScreensWithBlockBuilderAndBlockListenerState();
}

class _ScreensWithBlockBuilderAndBlockListenerState
    extends State<ScreensWithBlockBuilderAndBlockListener> {
  @override
